...
export default function MovieForum() {
    ...
    const movieDict = useSelector((state) => {
                ...
                <div className={"container mx-auto flex flex-col"}>
                    ...
                    <div className={"mt-5 border rounded-lg border-black mb-5"}>
                        ...
                        <form className="flex items-center p-4">
                            ...
                            <input type="text" className="border-none flex-1 focus:ring-0 outline-none pl-2" placeholder="Add a comment..." value={postComment} onChange={e => setPostComment(e.target.value)}/>
                            <button type={"submit"} disabled={!postComment.trim()} className="font-semibold text-blue-400 cursor-pointer disabled:cursor-not-allowed" onClick={sendComment}>Post</button>
                        </form>
                    </div>
                </div>
            )}
