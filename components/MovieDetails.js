...
import {CheckCircleIcon, PlusCircleIcon, StarIcon} from '@heroicons/react/outline'
    ...
    return (
        <>
            <div className={"rounded-lg text-center border-2 border-black m-1"}>
                ...
                } onClick={() => setOpen(true)}>Show More...
                </button>
            </div>
            <Transition.Root show={open} as={Fragment}>
                <Dialog as="div" className="relative z-[70]" initialFocus={cancelButtonRef} onClose={setOpen}>
                    <Transition.Child
                        as={Fragment}
                                ...
                                <Dialog.Panel
                                    ...
                                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <div className="sm:flex sm:items-start">
                                            {inWatchList ? <div
                                                className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10 hover:cursor-pointer hover:bg-red-200">
                                                <CheckCircleIcon className="h-6 w-6 text-red-600"
                                                                 aria-hidden="true"/>
                                            </div> : <div
                                                className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10 hover:cursor-pointer hover:bg-red-200">
                                                <PlusCircleIcon className="h-6 w-6 text-red-600" aria-hidden="true"
                                            ...
                                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div className="mt-2 overflow-hidden">
                                                    <img src={`${tmdbImageUrl + movie.movieDetails.poster_path}`}
                                                         className={"h-52"}/>
